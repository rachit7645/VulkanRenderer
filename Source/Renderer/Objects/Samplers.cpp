...
namespace Renderer::Objects
{
    ...
    )
    {
        ...
        (
            ...
            VkSamplerCreateInfo{
                ...
                .compareOp               = VK_COMPARE_OP_ALWAYS,
                .minLod                  = 0.0f,
                .maxLod                  = static_cast<f32>(IBL::PREFILTER_MIPMAP_LEVELS),
                .borderColor             = VK_BORDER_COLOR_FLOAT_OPAQUE_BLACK,
                .unnormalizedCoordinates = VK_FALSE
            }
        );

        pointShadowSamplerID = textureManager.AddSampler
        (
            megaSet,
            context.device,
            VkSamplerCreateInfo{
        ...
        imguiSamplerID = textureManager.AddSampler
        (
            megaSet,
            context.device,
            VkSamplerCreateInfo{
        ...
        spotShadowSamplerID = textureManager.AddSampler
        (
            megaSet,
            context.device,
            VkSamplerCreateInfo{
        ...
        bloomDownsampleSamplerID = textureManager.AddSampler
        (
            megaSet,
            context.device,
            VkSamplerCreateInfo{
        ...
        bloomUpsampleSamplerID = textureManager.AddSampler
        (
            megaSet,
            context.device,
            VkSamplerCreateInfo{
    ...
    )
    {
        ...
        const f32 mipLodBias = std::log2(renderXResolution / displayXResolution) - 1.0f;

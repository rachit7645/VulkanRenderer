...
namespace Renderer::Bloom::DownSample::FirstSample
{
    Pipeline::Pipeline
    (
    ...
    )
    {
        ...
        Vk::SetDebugName(context.device, handle, "Bloom/DownSample/FirstSample/Pipeline");
        Vk::SetDebugName(context.device, layout, "Bloom/DownSample/FirstSample/Pipeline/Layout");
    }
}

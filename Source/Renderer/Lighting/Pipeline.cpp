...
namespace Renderer::Lighting
{
    ...
    )
    {
        ...
        Vk::SetDebugName(context.device, textureManager.GetSampler(gBufferSamplerIndex).handle, "LightingPipeline/GBufferSampler");
        Vk::SetDebugName(context.device, textureManager.GetSampler(iblSamplerIndex).handle,     "LightingPipeline/IBLSampler");
        Vk::SetDebugName(context.device, textureManager.GetSampler(shadowSamplerIndex).handle,  "LightingPipeline/ShadowSampler");

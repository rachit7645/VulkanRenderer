...
namespace Renderer::GBuffer::DoubleSided
{
    Pipeline::Pipeline
    (
    ...
    )
    {
        ...
        Vk::SetDebugName(context.device, handle, "GBuffer/DoubleSided/Pipeline");
        Vk::SetDebugName(context.device, layout, "GBuffer/DoubleSided/Pipeline/Layout");
    }
}
...
namespace Renderer::Culling::Occlusion
{
    ...
    )
    {
        ...
        Vk::SetDebugName(context.device, handle,                                         "OcclusionCullingPipeline");
        Vk::SetDebugName(context.device, layout,                                         "OcclusionCullingPipelineLayout");
        Vk::SetDebugName(context.device, textureManager.GetSampler(samplerIndex).handle, "OcclusionCullingPipeline/HiZSampler");
    }
}
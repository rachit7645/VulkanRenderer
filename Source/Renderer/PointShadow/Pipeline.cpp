...
namespace Renderer::PointShadow
{
    Pipeline::Pipeline(const Vk::Context& context, const Vk::FormatHelper& formatHelper)
    {
        ...
        std::tie(handle, layout, bindPoint) = Vk::Builders::PipelineBuilder(context)
            ...
            .SetRenderingInfo(0b111111, {}, formatHelper.depthFormat, VK_FORMAT_UNDEFINED)
            .AttachShader("PointShadow.vert.spv", VK_SHADER_STAGE_VERTEX_BIT)
            .AttachShader("PointShadow.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT)
            ...
            .AddPushConstant(VK_SHADER_STAGE_VERTEX_BIT | VK_SHADER_STAGE_FRAGMENT_BIT, 0, sizeof(PointShadow::PushConstant))
            .Build();

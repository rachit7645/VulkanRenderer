...
#include "Util/Log.h"
#include "Shadows/SpotShadow/Opaque.h"
...
namespace Renderer::SpotShadow
{
    ...
    )
    {
        ...
        const VkViewport viewport =
        {
            .x        = 0.0f,
            .y        = 0.0f,
            .width    = static_cast<f32>(spotShadowMap.image.width),
            .height   = static_cast<f32>(spotShadowMap.image.height),
            .minDepth = 0.0f,
            .maxDepth = 1.0f
        };
        ...
        for (usize i = 0; i < sceneBuffer.lightsBuffer.shadowedSpotLights.size(); ++i)
        {
            ...
            // Opaque
            {
                ...
                // Single-Sided
                {
                    ...
                    vkCmdSetCullMode(cmdBuffer.handle, VK_CULL_MODE_FRONT_BIT);
